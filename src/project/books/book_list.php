    ...
    <body>
        <div class="container">
            ...
            <div class="width-12 filters navBar" style="flex-direction: row; gap: 5px">
                    <button class="largeButton buttonLight"><i class="fa-regular fa-newspaper"></i>Home</button>
        ...
        <section class="publisher">
            <div id="publishersD" class="container tabcontent hideDiv">
                ...
                <?php } else { ?>
                    <div id="book_cards" class="width-12 cards">
                        <?php foreach ($publishers as $publisher) { ?>
                            <?php $publisherId = Publisher::findById($publisher->id); ?>
                            <div class="card">
                                <div class="top-content">
                                    <p><?= h($publisherId->name) ?></p>
                                </div>
                                <div class="bottom-content" style="flex-direction: row">
                                    ...
                                    <div class="actions">
                                        ...
                                        <a href="publisher_delete.php?id=<?= h($publisherId->id) ?>">Delete</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
